...
import com.legacycode.eureka.samples.UseJavaRecord
...
class ClassScannerJavaTest {
  ...
  @Test
  fun `11 - it can scan a class that uses a Java record`() {
    // given
    val javaRecord = SampleClass.Java(UseJavaRecord::class)
